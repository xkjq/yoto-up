    ...
    try:
        ...
        try:
            ...
            if container is not None:
                ...
                container.controls.append(__import__('flet').Row([__import__('flet').Text('Alternatively open (click) this direct link: '), __import__('flet').TextButton(verification_uri_complete, on_click=lambda e, url=verification_uri_complete: __import__('webbrowser').open(url))]))
